...
add_action( 'widgets_init', 'st_flickr_widgets' );

// Register widget
function st_flickr_widgets() {
	register_widget( 'st_flickr_widget' );
}

// Widget class
class st_flickr_widget extends WP_Widget {
...
function st_flickr_widget() {

	// Widget settings
	$widget_ops = array(
		'classname' => 'st_flickr_widget',
		'description' => __('A widget that displays your Flickr photos.', 'framework')
	);

	/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'st_flickr_widget' );

	// Create the widget
	$this->WP_Widget( 'st_flickr_widget', __('Custom Flickr Photos', 'framework'), $widget_ops, $control_ops );
