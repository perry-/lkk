...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
  <article id="comment-<?php comment_ID(); ?>" class="comment-article clearfix">
    ...
    <div class="comment-action">
      <?php edit_comment_link( __( '<i class=" icon-edit"></i> Edit', 'framework' ), '', '&middot;' ); ?>
      <?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( '<i class="icon-reply"></i> Reply', 'framework' ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
    </div>
    <!-- .comment-action -->
