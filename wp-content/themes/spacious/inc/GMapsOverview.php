...
function initialize() {
    ...
    var mySize = <?php echo(sizeof($kodePlaces)); ?>;
  ...
  google.maps.event.addListener(searchBox, 'places_changed', function() {
    ...
    document.getElementById('position_field').value = input.value;
    document.getElementById('field_lat').value = places[0].geometry.location.lat();
    document.getElementById('field_long').value = places[0].geometry.location.lng();
